...
export class AsideComponent implements OnInit {
    ...
    constructor(private baseStoreService: BaseStoreService, private router:Router, private activatedRoute:ActivatedRoute) {
    ...
    submenuOpen(): void {
        ...
        const getIndex:number = getRoutes.findIndex(item => item.children && this.router.url.includes(item.path))
